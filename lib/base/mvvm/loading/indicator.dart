...
class MFActivityIndicator extends StatefulWidget {
  const MFActivityIndicator({
    Key key,
    this.animating = true,
  ...
  @override
  _MFActivityIndicatorState createState() => _MFActivityIndicatorState();
}


class _MFActivityIndicatorState extends State<MFActivityIndicator> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(MFActivityIndicator oldWidget) {
